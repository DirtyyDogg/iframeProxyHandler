## Making some modifications to this library to handle drect proxying for a specific URL 

For reference, the exact line which is fetching the file to proxy is at 106 in lib/node-iframe-replacement.js
